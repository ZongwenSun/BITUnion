...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    private int mDeliverState = DeliverState.UNKNOW;
     ...
     *
     * @deprecated Use {@link #Request(int, String, Response.Listener)}.
     */
    @Deprecated
    public Request(String url, Response.Listener listener) {
    ...
    /**
     * @return this request's {@link Response.Listener}.
     */
    ...
    protected void deliverStart() {
        if (mListener != null) {
            mListener.onStart();
        }
    }
    protected void deliverResponse(T response, boolean isResponseFromCache) {
        if (mListener != null) {
            mListener.onSuccess(response, isResponseFromCache);
        }
    }
