...
public class ImageLoader {
     ...
     */
    public static class ImageListener extends Response.SimpleListener {
        /**
    ...
    protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight,
        ...
        return new ImageRequest(requestUrl,
                new Response.SimpleListener<Bitmap>() {
                    @Override
                    public void onSuccess(Bitmap response, boolean isFromCache) {
