...
public class PostDetailAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (position == 0) {
			...
			holder.postSubjectText.setText(post.getSubject());
			holder.forumNameText.setText("我的大学");
			...
			holder.postAuthorText.setText(post.getAuthor());
			holder.postLevelText.setText("楼主");
			holder.postReplyTimeText.setText("00:00");
			holder.postContentText.setText(post.getMessage());
