...
public class ThreadActivity extends BaseActivity {
	...
	private void getNewPostsList() {
		...
		RequestQueueManager.getInstance().postJsonRequest(GlobalUrls.getPostListUrl(),
				RequestJsonFactory.PostListJson(loginInfo.getUsername(), loginInfo.getSession(), tid, "0", "19"), new Listener<JSONObject>() {
					...
					public void onErrorResponse(VolleyError arg0) {
						// TODO Auto-generated method stub
						hideLoadingDialog();
						ToastHelper.showToast(ThreadActivity.this, arg0.toString());
					}
				});
